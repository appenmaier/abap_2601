...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD ValidateCustomer.
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_00_TravelTP.

    " Read Travels
    READ ENTITIES OF ZR_00_TravelTP IN LOCAL MODE
         ENTITY Travel
         FIELDS ( CustomerId )
  ...
  METHOD DetermineStatus.
    DATA travels TYPE TABLE FOR UPDATE zr_00_travelTp.
    ...
    MODIFY ENTITIES OF ZR_00_TravelTP IN LOCAL MODE
           ENTITY Travel
           UPDATE
           FIELDS ( Status )
           WITH travels.
