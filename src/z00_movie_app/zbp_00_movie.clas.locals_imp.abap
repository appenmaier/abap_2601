...
CLASS lhc_rating IMPLEMENTATION.
  METHOD DeterminRatingDate.
    DATA ratings TYPE TABLE FOR UPDATE zr_00_ratingtp.
    ...
    MODIFY ENTITIES OF ZR_00_MovieTP IN LOCAL MODE
           ENTITY Rating
           UPDATE
           FIELDS ( RatingDate )
           WITH ratings.
...
CLASS lhc_Movie IMPLEMENTATION.
  ...
  METHOD ValidateGenre.
    DATA movies TYPE TABLE FOR READ RESULT zr_00_movietp.

    " Read Movies
    READ ENTITIES OF ZR_00_MovieTP IN LOCAL MODE
         ENTITY Movie
         FIELDS ( Genre )
  ...
  METHOD RateMovie.
    DATA ratings TYPE TABLE FOR CREATE ZR_00_MovieTP\_Ratings.
